...
impl ABCHandler {
    ...
    pub(crate) fn _getNextLineBreak(&self, strSrc: String, i: IntegerType) -> IntegerType {
        todo!()
    }
    ...
    pub(crate) fn _buildMeasureBoundaryIndices(&self, positionList: , lastValidIndex: IntegerType) {
        todo!()
    }
