...
impl Duration {
    ...
    //     todo!()
    // }
    // pub(crate) fn componentStartTime(&self, componentIndex: IntegerType) -> FloatType {
    //     todo!()
    // }
    ...
    //     todo!()
    // }
    // pub(crate) fn dots(&self) -> IntegerType {
    //     todo!()
    // }
    // pub(crate) fn dots(&self, value: IntegerType) {
    //     todo!()
    // }
    ...
    //     todo!()
    // }
    // pub(crate) fn quarterLengthNoTuplets(&self) -> FloatType {
    //     todo!()
    // }
